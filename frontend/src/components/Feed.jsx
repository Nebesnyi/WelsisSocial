...
// ── Тот же набор эмодзи что в ChatWindow ─────────────────────────────────────
const EMOJI_TABS = [
  { label:'😀', emojis:['😀','😃','😄','😁','😆','😅','🤣','😂','🙂','🙃','😉','😊','😇','🥰','😍','🤩','😘','😗','😚','😙','😋','😛','😜','🤪','😝','🤑','🤗','🤭','🤫','🤔','😐','😑','😶','😏','😒','🙄','😬','🤥','😌','😔','😪','🤤','😴','😷','🤒','🤕','🤢','🤮','🥵','🥶','😱','😨','😰','😥','😓','🤯','😭','😢','😤','😠'] },
...
function EmojiPickerInline({ onSelect, onClose }) {
  ...
  return (
    <div ref={ref} style={{
      ...
      <div 
        ref={scrollRef}
        style={{ padding:8, display:'grid', gridTemplateColumns:'repeat(10, 1fr)', gap:2, maxHeight:200, overflowY:'auto', overflowX:'hidden' }}
        onWheel={(e) => {
          e.stopPropagation();
          e.preventDefault();
